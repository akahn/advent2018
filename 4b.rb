...
class Guard
  ...
  def <=>(other)
    sleepiest_minute_count <=> other.sleepiest_minute_count
  end

  def sleepiest_minute_count
    minute_distribution[sleepiest_minute]
  end
  ...
  def to_s
    "##{@id} total=#{@total_minutes}, sleepiest_minute=#{sleepiest_minute}, sleepiest_minute_count=#{sleepiest_minute_count}"
  end
end
